...
class ParserTests : LoxTestCase
{
    ...
    //
    // /**
    //  Verify the expressions produced from tokens with a single unary
    //  operator and value.
    //  */
    // func testUnarySimple()
    // {
    //     let minusTokens = [
    ...
    //         Token.eof(1),
    //     ]
    //     let minusExpression = Expression.unary(op: minusTokens[0],
    //                                            .literal(minusTokens[1].literal!))
    //     let minusParser = Parser(tokens: minusTokens)
    //     XCTAssertEqual(minusExpression, minusParser.parse())
    //
    //     let bangTokens = [
    ...
    //         Token.eof(1),
    //     ]
    //     let bangExpression = Expression.unary(op: bangTokens[0], .false)
    //     let bangParser = Parser(tokens: bangTokens)
    //     XCTAssertEqual(bangExpression, bangParser.parse())
    // }
    //
    // //MARK:- Primary
    //
